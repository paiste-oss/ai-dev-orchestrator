...
export default function AdminDashboard() {
  ...
  const [data, setData] = useState<DashboardData>({
    total_customers: 0, online_now: 0, pending_entwicklung: 0, recent: [], health: null,
  });
  ...
  const allOk = data.health?.services
    ? Object.values(data.health.services).every(s => s === "ok")
    : false;
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-8 pt-8 pb-12 space-y-6">
      ...
      <div className="pt-2 text-xs text-gray-800">Baddi Admin</div>
