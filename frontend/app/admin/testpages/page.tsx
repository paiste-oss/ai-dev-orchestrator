...
const ALL_PAGES: PageEntry[] = [
  ...
  // ── Admin ────────────────────────────────────────────────────────────────────
  {
    ...
    icon: "🏠",
    role: "admin",
    description: "Übersicht mit KPI-Kacheln, Entwicklungs-Alert & Schnellzugriff",
    group: "Admin",
  },
  {
  ...
  },
  {
    ...
    icon: "◈",
    role: "admin",
    description: "Alle persönlichen Baddis — Übersicht mit Kundeninfos & Aktivität",
    group: "Admin",
  },
  {
    path: "/admin/entwicklung",
    label: "Entwicklung",
    icon: "⚗",
    role: "admin",
    description: "Selbstentwickelndes Uhrwerk — neue Fähigkeiten auf Kundenwunsch",
    group: "Admin",
  },
  {
  ...
  },
  {
    ...
    icon: "🎨",
    role: "admin",
    description: "Layout & Theme des Admin-Centers auswählen",
    group: "Admin",
  },
  {
    path: "/admin/settings",
    ...
    icon: "🔧",
    role: "admin",
    description: "Portal-Einstellungen & Impressum",
    group: "Admin",
  },
  {
