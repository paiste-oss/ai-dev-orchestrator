  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 border-b border-white/5 px-2 py-1.5 flex gap-1.5 items-center">
        ...
        <button onClick={() => fileRef.current?.click()} title="Datei hochladen"
        ...
        <button onClick={() => { setZoom(1); setOffset({ x: 0, y: 0 }); }}
          className="px-1.5 py-1 rounded text-gray-500 hover:text-white hover:bg-white/8 text-xs transition-colors" title="Einpassen">⌂</button>
      ...
      >
        ...
        {url && !error && (
          ...
          <img
            ...
            alt="Bild"
            style={{
              /* object-contain fills the container and auto-reflows on resize.
                 zoom/pan is then applied on top via transform. */
              width: "100%",
              height: "100%",
              objectFit: "contain",
