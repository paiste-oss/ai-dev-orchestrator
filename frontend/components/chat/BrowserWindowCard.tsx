    ...
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 border-b border-white/5 px-2 py-1.5 flex gap-1.5 items-center">
        ...
        <button
          ...
          className="px-2 py-1 rounded-lg bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-[var(--accent-text)] text-xs disabled:opacity-40 transition-colors shrink-0"
        >
          →
        </button>
        ...
        {state && (
          <button
            ...
            title="Text tippen"
            className={`p-1 rounded transition-colors shrink-0 ${showTypeBar ? "text-[var(--accent-light)] bg-[var(--accent-15)]" : "text-gray-500 hover:text-white hover:bg-white/8"}`}
          >
      ...
      {showTypeBar && (
        <div className="shrink-0 border-b border-white/5 px-2 py-1.5 flex gap-1.5">
          ...
          <button
            ...
            className="px-2 py-1 rounded-lg bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-[var(--accent-text)] text-xs transition-colors shrink-0">
            ↵ Senden
          </button>
        </div>
      )}
