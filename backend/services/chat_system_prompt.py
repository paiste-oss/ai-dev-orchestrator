...
def build_system_prompt(
    ...
    system_parts.append(
        ...
        "- ASSISTENZ vs. BROWSER:\n"
        "  • Anmelden / Registrieren / Formular ausfüllen / 'ich verstehe das nicht' → IMMER [FENSTER: assistenz | URL]\n"
        "    Bekannte URLs: AHV=https://www.ahv-iv.ch, SBB=https://www.sbb.ch, Post=https://www.post.ch, Behörden=https://www.ch.ch\n"
        "  • Nur schauen / lesen / öffnen ohne Hilfe → [OPEN_URL: URL]\n"
        "  Beispiel Assistenz: 'Ich helfe dir bei der Anmeldung. [FENSTER: assistenz | https://www.ahv-iv.ch]'\n"
