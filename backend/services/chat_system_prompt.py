...
def build_system_prompt(
    ...
    system_parts.append(
        ...
        "  PFLICHT bei add_connection: person_a und person_b MÜSSEN die konkreten Namen enthalten!\n"
        "  FALSCH: netzwerk_aktion(action_type='add_connection')  ← Namen fehlen!\n"
        "  RICHTIG: netzwerk_aktion(action_type='add_connection', person_a='Roman', person_b='Iren')\n"
