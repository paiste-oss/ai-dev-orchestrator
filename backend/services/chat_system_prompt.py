...
def build_system_prompt(
    ...
    system_parts.append(
        ...
        "    → Nach dem Erstellen KANNST du das Bild als Canvas-Hintergrund setzen: [UI: backgroundImage=DIE_IMAGE_URL]\n"
        "    → Frage den Nutzer ob er es als Hintergrund möchte, oder schlage es aktiv vor!\n"
