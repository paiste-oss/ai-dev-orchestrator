...
TOOL_CATALOG: dict[str, dict] = {
    ...
    "browser": {
        "key": "browser",
        "name": "Browser & Assistenz",
        "description": "Öffnet Webseiten in einem neuen Tab oder startet den Assistenz-Modus für Anmeldungen und Formulare.",
        "prompt_hint": "Webseiten öffnen, Nutzer bei Anmeldungen und Formularen assistieren",
        "category": "productivity",
        "tier": "pro",
        "tool_defs": BROWSER_TOOL_DEFS,
        "tool_names": {"open_url", "open_assistenz"},
    ...
    "library": {
        ...
        "description": "Semantische Suche & Volltext-Abruf für Literatur (Paper/Bücher/Patente), Dokumente, sowie globaler Wissenspool via Crossref/Unpaywall.",
        "prompt_hint": "Semantische Suche in eigener Bibliothek + globaler Pool (DOI, Open-Access-Links, Crossref-Metadaten)",
        "category": "data",
        "tier": "free",
        "tool_defs": LIBRARY_TOOL_DEFS,
        "tool_names": {"library_search", "library_read", "library_recent",
                       "literature_global_search", "literature_get_by_doi",
                       "book_global_search", "book_get_by_isbn",
                       "law_get_by_sr", "patent_get_by_number"},
